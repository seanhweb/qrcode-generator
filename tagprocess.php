				...
				echo '  <div class="qrCodeSingle">
					...
					switch ($itemName1) {
							...
							echo			'<div class="qrCodeSingle">
											...
											<iframe scrolling="no" src="http://chart.apis.google.com/chart?chl='. $itemNumber1 .'&chs=50x50&cht=qr&chld=H%7C0"></iframe>
					...
					switch ($itemName6) {
						...
						switch ($itemName11) {
							case isset($_POST['itemName11']):
							echo			'<div class="qrCodeSingle">
											<p class="itemDesc">'. $itemName11 .'</p>
											<iframe scrolling="no" src="http://chart.apis.google.com/chart?chl='. $itemNumber11 .'&chs=50x50&cht=qr&chld=H%7C0"></iframe>
											<p class="itemNum">'. $itemNumber11 .'</p>
											</div>';
							break;
							
							case empty($_POST['itemName11']):
							//do nothing
							break;			
						}	
						switch ($itemName12) {
							case isset($_POST['itemName12']):
							echo			'<div class="qrCodeSingle">
											<p class="itemDesc">'. $itemName12 .'</p>
											<iframe scrolling="no" src="http://chart.apis.google.com/chart?chl='. $itemNumber12 .'&chs=50x50&cht=qr&chld=H%7C0"></iframe>
											<p class="itemNum">'. $itemNumber12 .'</p>
											</div>';
							break;
							
							case empty($_POST['itemName12']):
							//do nothing
							break;			
						}																																																
					echo '</div></div>'; ?>